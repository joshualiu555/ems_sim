...
TEST_F(DatabaseTest, Insert) {
  Call c = {1, 0, CallPriority::Alpha, "", {0, 0}};
  Ambulance a = {1, AmbulanceStatus::Available, AmbulanceType::ALS, {0, 0}, {0, 0}};
  Hospital h = {1, 0, 10, {0, 0}};
...
TEST_F(DatabaseTest, ForeignKeyViolation) {
  Event e = {0, EventType::CallReceived, 999, -1, -1};
